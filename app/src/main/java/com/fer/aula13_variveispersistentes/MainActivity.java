...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPts = findViewById(R.id.txtPts);
        txtPtsMaximo = findViewById(R.id.txtRecorde);
    ...
    private void minhaEngine() {
        ...
        an = (AnimationDrawable) ContextCompat
                .getDrawable(this, R.drawable.animacao);
    ...
    private void ativaImagem(ImageView v, int fps) {
        ...
        v.setEnabled(true);
        snd.play(s_mosq,0.3f,0.3f,3,0,1);
